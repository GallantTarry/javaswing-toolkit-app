...
public class ReplacerPanel extends BackgroundPanel {
    ...
    private void processFile(File src, Map<String, String> map) {
        ...
        try {
            // ✨ 修复点 1：让 InputStream 在这个内部 try 块结束后立刻自动释放！解开原文件上的读写锁！
            ...
            } // ✨ 到这里，内部的 try 结束了，is 输入流被系统强制关闭，原文件自由了！

            // ✨ 修复点 2：在没有流占用的情况下，进行安全的文件覆盖
            ...
            // ✨ 修复点 3：这里换成了 Throwable！
            // 不管是普通的 Exception 还是恐怖的 OutOfMemoryError，现在全都能被网住！
