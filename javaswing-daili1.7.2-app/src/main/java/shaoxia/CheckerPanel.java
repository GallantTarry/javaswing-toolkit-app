...
/**
 * 数据校对助手 CheckerPanel (毛玻璃圆润监听区 + 极客透明胶囊返回按钮)
...
public class CheckerPanel extends BackgroundPanel {
    ...
    public CheckerPanel(MainLauncher parent) {
        ...
        gbc.gridy = 1; gbc.weightx = 1.0; gbc.weighty = 4.5;
    ...
    private void adjustFontSize() {
        ...
        // ✨ 动态通过 span 和内联样式计算文字大小，完美适配缩放
        int dlTitleSize = (int) (22 * scale);
        int dlSubSize = (int) (14 * scale);
        dl.setText("<html><center>" +
                "<span style='font-size:" + dlTitleSize + "px; font-weight:bold; color:white;'>拖入 XLSX 进行逻辑校验</span><br><br>" +
