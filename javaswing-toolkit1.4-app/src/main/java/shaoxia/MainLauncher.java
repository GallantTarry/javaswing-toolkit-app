...
import shaoxia.modules.SavePigPanel;
 ...
 * ✨ 本版特性：彻底消除图标锯齿，引入 Graphics2D 硬件级 BICUBIC 高清重采样
 */
public class MainLauncher extends JFrame {
    ...
    public MainLauncher() {
        ...
        //mainContainer.add(new HavenPanel(this), "DEV"); // 根据需要取消注释
    ...
    private JPanel createMainMenu() {
        ...
        JButton btn9 = createModuleButton("DEV", glassColor, "/icons/dev.png");
    ...
    /**
     * ✨ 全新终极高清缩放：抛弃原生模糊的 getScaledInstance
     * 使用 Graphics2D 的 BICUBIC（双三次插值）进行重采样计算
     */
            ...
            if (imgURL != null) {
                ...
                btn.addComponentListener(new ComponentAdapter() {
                    ...
                    public void componentResized(ComponentEvent e) {
                        ...
                        // ✨ 核心修复区：建立一张支持透明度的全空白画布
                        BufferedImage scaledImg = new BufferedImage(iconSize, iconSize, BufferedImage.TYPE_INT_ARGB);
                        Graphics2D g2 = scaledImg.createGraphics();

                        // 强制开启顶级渲染效果
                        g2.setRenderingHint(RenderingHints.KEY_INTERPOLATION, RenderingHints.VALUE_INTERPOLATION_BICUBIC); // 双三次插值，保证线条不发虚
                        g2.setRenderingHint(RenderingHints.KEY_RENDERING, RenderingHints.VALUE_RENDER_QUALITY);
                        g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);

                        // 把 200x200 原图平滑挤压到这张画布上
