...
public class ScoringPanel extends BackgroundPanel {
    ...
    public ScoringPanel(MainLauncher parent) {
        ...
        // 中心排版标语
        // 1. 补全了 &nbsp; 的分号
        // 2. 弃用 <font>，改用内联 CSS 严格控制样式，Swing 对此支持更好
        // 3. 末尾多加了几个全角空格或通过 CSS margin 撑开安全区，防止系统字体加粗导致的意外截断
        // 核心修复：移除 &nbsp; 改用常规空格，并增加 line-height 优化视觉垂直间距
        JLabel innerLabel = new JLabel("<html>" +
                "<div style='text-align: center; font-family: monospace; font-size: 24px; color: white; line-height: 1.6;'>" +
                "WE ARE<br>" +
                "\uD83D\uDD4A ALL<br>" +
                "GREAT<br>" +
                "APES" +
...
// 保持现有的边距设置，给高分屏渲染留出呼吸空间
        innerLabel.setBorder(BorderFactory.createEmptyBorder(0, 10, 0, 10));
