...
public class ComparisonPanel extends BackgroundPanel {
    ...
    public ComparisonPanel(MainLauncher parent) {
        ...
        wordLabel = new JLabel("【Drop DOCX】", JLabel.CENTER);
        ...
        pdfLabel = new JLabel("【Drop PDF】", JLabel.CENTER);
        ...
        ActionButton btnRun = new ActionButton("Run Check");
        ActionButton btnBack = new ActionButton("<< Menu");
        ...
        new DropTarget(dropTargetArea, new DropTargetAdapter() {
            public void drop(DropTargetDropEvent dtde) {
                try {
                    ...
                    // 更新文字状态
                    labelToUpdate.setText("<html><center>Loaded<br/>" + f.getName() + "</center></html>");
